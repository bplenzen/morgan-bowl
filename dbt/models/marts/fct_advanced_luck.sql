...
expected_wins_calc as (
    select
        ...
        all_play_games,
        all_play_win_pct,
        -- Expected wins = all-play win% Ã— actual games played
        round(
...
final as (
    select
        ...
        round(
            50
            -- Â±10 per win over/under expected
...
select
    ...
    -- All-play record (beat X out of 66 possible matchups if 6 weeks Ã— 11 opponents)
    all_play_wins,
    all_play_games,
    all_play_win_pct,
